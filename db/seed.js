...
},
{
    ...
    'bio': "I just got a new dog and she needs some friends to play with. Maybe there's someone someone who, like me, barely has the time to give my dog the socialization and exercise she needs. I have a fenced-in backyard--message me if you can drop your dog off for a playdate and we can both find something more productive to do with our time. Plus, you get to meet a puppy.",
    'interests:' {
        'dogInterest': true,
        'humanInterest': false
    }
...
},
{
    ...
    'password': 'mollyiscute',
    'avatar': 'public/images/johnjohnson.jpeg',
    'dogs': [{
        'name': 'Zoe',
        'weight': '25 pounds',
        'age': '6 months',
        'breed': 'golden retreiver',
        'avatar': 'public/images/zoe.jpeg',
        'additionalInfo': "I'm very friendly and get along with every dog I meet. I have more and more energy every day, and I could use a friend that could come over for playdates.",
    }]
}]
